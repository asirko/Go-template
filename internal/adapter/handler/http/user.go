...
//	@Description	create a new user account with default role "basic-user"
//	@Tags			Users
//	@Accept			json
//	@Produce		json
...
type listUsersRequest struct {
	Skip  uint64 `form:"skip,default=0" binding:"min=0" example:"0"`
	Limit uint64 `form:"limit,default=10" binding:"min=1" example:"5"`
}
